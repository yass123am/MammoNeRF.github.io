...
def parse_args():
    ...
    parser.add_argument('--scene_name', type=str, default='without_pectoral')
...
def main(args):
    ...
    cc_c2w = torch.tensor([[1.0000e+00, 0, 0,  2],
        [0,  0,  1.0000e+00, 2],
        [ 0, -1.0000e+00,  0, 0],
    ...
    focal_net = load_ckpt_to_net('logs/any_folder/without_pectoral/lr_0.001_gpu0_seed_17_resize_16_Nsam_15_Ntr_img_-1_freq_10__250705_1327/latest_focal.pth', focal_net, map_location=my_devices)

    #pose_param_net = LearnPose(scene_train.N_imgs, args.learn_R, args.learn_t, init_c2w=init_c2w)
    #pose_param_net = load_ckpt_to_net('logs/any_folder/without_pectoral/lr_0.001_gpu0_seed_17_resize_16_Nsam_15_Ntr_img_-1_freq_10__250705_1327/latest_pose.pth', pose_param_net, map_location=my_devices)
    ...
    '''Get frustums'''
    frustum_est_list = draw_camera_frustum_geometry(init_c2w.cpu().numpy(), scene_train.H, scene_train.W,
                                                    fxfy[0], fxfy[1],
